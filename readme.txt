...
**Page Title Mode**
1. `Full Title Replacement (default option)` - Replaces the whole title tag
1. `Partial Title Replacement` - Keeps the WordPress blog name in the title tag
...
1. `Ignore Title` - means no replacements occur

**Search/List/Detail/Category Page Title Mode**
1. `Default Behaviour` - uses the setting from "Page Title Mode"
1. `Full Title Replacement (default option)` - Replaces the whole title tag
1. `Partial Title Replacement` - Keeps the WordPress blog name in the title tag
1. `Append Title` - Existing title is kept, additional title is added to the end
1. `Prepend Title` - Existing title is kept, additional title is added to the start
